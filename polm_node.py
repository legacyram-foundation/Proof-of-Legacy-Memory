...
class PoLMNode:
    ...
    def _miner_loop(self) -> None:
        ...
        while self._running.is_set():
            ...
            ram_proof = compute_ram_proof(seed, self.ram_mult, self.buffer, ram_type=self.ram_type, block_hash=self.chain.tip["hash"] if self.chain.tip else "")
